...
/**
 * struct NvmeTcpHdr - nvme tcp pdu common header
 *
 * @type:          pdu type
...
/**
 * struct NvmeTcpIcreqPdu - nvme tcp initialize connection request pdu
 *
...
/**
 * struct NvmeTcpIcrespPdu - nvme tcp initialize connection response pdu
 *
